...
import fr.triedge.minecraft.plugin.JikaiPlugin1_13;
import fr.triedge.minecraft.plugin.utils.Utils;

public class CustomInventory {

	private ConfigurationHandler config;
	private JikaiPlugin1_13 plugin;
	private HashMap<String, Inventory> inventories = new HashMap<>();

	public CustomInventory(ConfigurationHandler config, JikaiPlugin1_13 plugin) {
		super();
		this.config = config;
		this.plugin = plugin;
	}
	...
	public JikaiPlugin1_13 getPlugin() {
		return plugin;
	}

	public void setPlugin(JikaiPlugin1_13 plugin) {
		this.plugin = plugin;
	}
